...
from agent_prototype.infrastructure.database.models import SessionRunRecord
...
from agent_prototype.application.runtime.executor import _executor, _global_futures
