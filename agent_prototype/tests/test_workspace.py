...
from agent_prototype.infrastructure.database.repositories.workspace_store import SqliteWorkspaceStore
from agent_prototype.application.services.workspace_service import WorkspaceService
...
class TestWorkspaceService(unittest.TestCase):
    ...
    @patch("agent_prototype.application.services.workspace_service.open_folder_dialog")
