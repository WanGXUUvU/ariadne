...
_MOCK_PATH = "agent_prototype.execution.runtime.agent_runtime.AgentRunner"
_BUILDER_MOCK_PATH = "agent_prototype.tools.builtin.agent_bridge.spawn_child_agent.RunContextBuilder"
