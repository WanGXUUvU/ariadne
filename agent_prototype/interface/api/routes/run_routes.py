...
from agent_prototype.interface.dto.schemas import AgentInput, AgentOutput, ResetInput, FinalizeRunInput, RunDetailResponse, ToolCallSummary  # 导入请求响应模型
from agent_prototype.application.services.run.run_service import RunService
from agent_prototype.application.runtime.executor import _global_futures  # 导入全新的 RunService
from agent_prototype.application.services.session_service import SessionService  # 导入全新的 SessionService
