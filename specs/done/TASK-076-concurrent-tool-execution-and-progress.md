...
1.  **领域类型层**：[types.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/execution/runtime/types.py) 中新增 `tool_progress` 类型的 `AgentEvent` 放行。
2.  **安全中间件层**：[base.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/security/middleware/base.py) 中的 `ToolCallContext` 支持传入 `on_progress` 回调，挂载 `emit_progress`便捷入口。
3.  **运行时执行引擎**：[tool_runner.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/execution/runtime/tool_runner.py) 
...
4.  **流式问答编排层**：[stream_run_session.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/execution/streaming/stream_run_session.py) 适配新增的 `tool_progress` 帧，以 SSE 流刷向前端。
5.  **前端界面与类型适配**：
...
*   **修改**：[types.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/execution/runtime/types.py) / [base.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/security/middleware/base.py)
*   **实现**：
...
*   **修改**：[web_search.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/infrastructure/tools/builtin/web_search.py) (或新增长耗时 Demo 工具)
*   **实现**：
...
*   **修改**：[tool_runner.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/execution/runtime/tool_runner.py)
*   **实现**：
...
*   **修改**：[stream_run_session.py](file:///Users/wangxu/Documents/AGENT%20Build/agent_prototype/execution/streaming/stream_run_session.py)
*   **实现**：
