...
from backend.infra.db.orm_models import Base  # 导入你项目里的 Base，这里挂着所有模型元数据
import backend.infra.db.orm_models  # noqa: F401  # 导入模型模块，这样 SessionRecord 才会注册到 Base.metadata 上
